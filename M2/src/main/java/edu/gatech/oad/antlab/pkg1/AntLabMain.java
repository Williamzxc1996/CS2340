 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("XunchengZhou");
		  toPrint += p1.toString("903423628");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Zhiquan");
		  toPrint += p2.toString("903427730");
		  ...
		  toPrint += p3.toString("903361619");
                  ...
                  Person4 p4 = new Person4("Xiaoyou Jiang");
                  toPrint += p4.toString("903427782");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("XiangZhong");
                  toPrint += p5.toString("903526232");
